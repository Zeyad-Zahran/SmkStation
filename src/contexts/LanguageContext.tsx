...
const translations = {
  en: {
    ...
    'home.hero.subtitle': 'Premium quality fish and seafood from the finest sources',
    ...
    'order.success_message': 'Thank you for your order. We will contact you soon to confirm delivery details.',
    ...
    'about.description': 'We are passionate about bringing you the freshest, highest quality seafood from trusted sources. Our commitment to excellence and customer satisfaction has made us the preferred choice for seafood lovers.',
    'about.mission': 'Our Mission',
    'about.mission_text': 'To provide fresh, sustainable, and premium quality seafood with exceptional service and fast delivery.',
    'about.vision': 'Our Vision',
    'about.vision_text': 'To become the leading online seafood marketplace, connecting customers with the finest marine products.',
    ...
    'footer.newsletter_text': 'Subscribe to get updates on new products and offers',
  ...
  ar: {
    ...
    'order.success_message': 'شكراً لك على طلبك. سنتواصل معك قريباً لتأكيد تفاصيل التوصيل.',
    ...
    'about.description': 'نحن شغوفون بتقديم أطازج وأعلى جودة من المأكولات البحرية من مصادر موثوقة. التزامنا بالتميز ورضا العملاء جعلنا الخيار المفضل لمحبي المأكولات البحرية.',
    'about.mission': 'رسالتنا',
    'about.mission_text': 'تقديم مأكولات بحرية طازجة ومستدامة وعالية الجودة مع خدمة استثنائية وتوصيل سريع.',
    'about.vision': 'رؤيتنا',
    'about.vision_text': 'أن نصبح السوق الإلكتروني الرائد للمأكولات البحرية، نربط العملاء بأفضل المنتجات البحرية.',
    'about.values': 'قيمنا',
    ...
    'footer.newsletter_text': 'اشترك للحصول على تحديثات المنتجات والعروض الجديدة',
